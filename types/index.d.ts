...
type ExtendStandardFields = {
    fieldType?: FieldTypes.CHECKBOX | FieldTypes.DATE | FieldTypes.NUMBER | FieldTypes.PASSWORD | FieldTypes.TEXTAREA | FieldTypes.HTML;
    dropdown?: never;
...
export type ColumnDefinition<TData, TValue = unknown> = ColumnDef<TData, TValue> & {
...
} & (ExtendStandardFields | ExtendMultiSelectField | ExtendSelectField | ExtendTextField);
export type SelectOption = {
    value: string;
    name: string;
};
export type Variant = 'primary' | 'secondary' | 'success' | 'info' | 'danger' | 'warning';
