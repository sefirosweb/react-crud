...
externalFilters.args = {
    ...
    columns: [
        ...
        {
            titleOnCRUD: 'Options with value',
            Header: 'Options with value',
            accessor: 'field_type_id',
            Cell: (row) => row.cell.row.original.field_type,
            type: 'select',
            selectOptionsUrl: '/api/getSelectOptions',
            editable: true,
            canSearch: true,
        },
        {
            titleOnCRUD: 'Options',
            Header: 'Options',
            accessor: 'field_type_options',
            type: 'select',
            selectOptionsUrl: '/api/multiselect/get_array',
            editable: true,
            canSearch: true,
        },
    ],
